 ...
 * @author varargs
 */
public class InsertQus extends javax.swing.JInternalFrame {

    /**
     * Creates new form InsertQus
     */
    String type;

    public InsertQus(String type) {
        initComponents();
        this.type = type;
        this.setTitle("Question for " + type);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (Ans != 0) {
                ...
                mid3.insertQuestion(type1, Qus, op1, op2, op3, op4, ""+Ans);
